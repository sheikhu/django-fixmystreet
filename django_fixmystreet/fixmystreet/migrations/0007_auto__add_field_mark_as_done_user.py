...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fixmystreet_report', 'mark_as_done_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reports_solved', null=True, to=orm['fixmystreet.FMSUser']),
                      keep_default=False)

        # Adding field 'HistoricalReport.mark_as_done_user_id'
        db.add_column(u'fixmystreet_historicalreport', 'mark_as_done_user_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'fixmystreet_historicalreport', 'mark_as_done_user_id')
