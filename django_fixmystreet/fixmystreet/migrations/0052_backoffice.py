...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportReopenReason'
        db.create_table(u'fixmystreet_reportreopenreason', (
            (u'reportcomment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fixmystreet.ReportComment'], unique=True, primary_key=True)),
            ('reason', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'fixmystreet', ['ReportReopenReason'])


    def backwards(self, orm):
        # Deleting model 'ReportReopenReason'
        db.delete_table(u'fixmystreet_reportreopenreason')
