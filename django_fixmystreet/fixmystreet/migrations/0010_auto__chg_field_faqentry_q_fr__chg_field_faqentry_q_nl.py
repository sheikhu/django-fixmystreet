...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FaqEntry.q_fr'
        db.alter_column(u'fixmystreet_faqentry', 'q_fr', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'FaqEntry.q_nl'
        db.alter_column(u'fixmystreet_faqentry', 'q_nl', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'FaqEntry.q_fr'
        db.alter_column(u'fixmystreet_faqentry', 'q_fr', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'FaqEntry.q_nl'
        db.alter_column(u'fixmystreet_faqentry', 'q_nl', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
