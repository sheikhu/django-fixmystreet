...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field previous_managers on 'Report'
        db.create_table(u'fixmystreet_report_previous_managers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm[u'fixmystreet.report'], null=False)),
            ('fmsuser', models.ForeignKey(orm[u'fixmystreet.fmsuser'], null=False))
        ))
        db.create_unique(u'fixmystreet_report_previous_managers', ['report_id', 'fmsuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field previous_managers on 'Report'
        db.delete_table('fixmystreet_report_previous_managers')
