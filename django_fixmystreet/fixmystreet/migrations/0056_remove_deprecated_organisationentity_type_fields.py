...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HistoricalOrganisationEntity.subcontractor'
        db.delete_column(u'fixmystreet_historicalorganisationentity', 'subcontractor')
        ...
        # Deleting field 'HistoricalOrganisationEntity.commune'
        db.delete_column(u'fixmystreet_historicalorganisationentity', 'commune')

        # Deleting field 'HistoricalOrganisationEntity.region'
        db.delete_column(u'fixmystreet_historicalorganisationentity', 'region')

        # Deleting field 'HistoricalOrganisationEntity.applicant'
        db.delete_column(u'fixmystreet_historicalorganisationentity', 'applicant')

        # Deleting field 'OrganisationEntity.subcontractor'
        db.delete_column(u'fixmystreet_organisationentity', 'subcontractor')

        # Deleting field 'OrganisationEntity.department'
        db.delete_column(u'fixmystreet_organisationentity', 'department')

        # Deleting field 'OrganisationEntity.commune'
        db.delete_column(u'fixmystreet_organisationentity', 'commune')

        # Deleting field 'OrganisationEntity.region'
        db.delete_column(u'fixmystreet_organisationentity', 'region')

        # Deleting field 'OrganisationEntity.applicant'
        db.delete_column(u'fixmystreet_organisationentity', 'applicant')


    def backwards(self, orm):
        # Adding field 'HistoricalOrganisationEntity.subcontractor'
        db.add_column(u'fixmystreet_historicalorganisationentity', 'subcontractor',
        ...
        # Adding field 'HistoricalOrganisationEntity.commune'
        db.add_column(u'fixmystreet_historicalorganisationentity', 'commune',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalOrganisationEntity.region'
        db.add_column(u'fixmystreet_historicalorganisationentity', 'region',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalOrganisationEntity.applicant'
        db.add_column(u'fixmystreet_historicalorganisationentity', 'applicant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OrganisationEntity.subcontractor'
        db.add_column(u'fixmystreet_organisationentity', 'subcontractor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'OrganisationEntity.commune'
        db.add_column(u'fixmystreet_organisationentity', 'commune',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OrganisationEntity.region'
        db.add_column(u'fixmystreet_organisationentity', 'region',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OrganisationEntity.applicant'
        db.add_column(u'fixmystreet_organisationentity', 'applicant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
