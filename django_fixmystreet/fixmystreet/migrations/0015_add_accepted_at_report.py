...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.accepted_at'
        db.add_column(u'fixmystreet_report', 'accepted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalReport.accepted_at'
        db.add_column(u'fixmystreet_historicalreport', 'accepted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.accepted_at'
        db.delete_column(u'fixmystreet_report', 'accepted_at')

        # Deleting field 'HistoricalReport.accepted_at'
        db.delete_column(u'fixmystreet_historicalreport', 'accepted_at')
