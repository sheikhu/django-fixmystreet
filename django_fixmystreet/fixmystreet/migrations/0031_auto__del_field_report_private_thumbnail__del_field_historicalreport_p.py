...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report.private_thumbnail'
        db.delete_column(u'fixmystreet_report', 'private_thumbnail')

        # Deleting field 'HistoricalReport.private_thumbnail'
        db.delete_column(u'fixmystreet_historicalreport', 'private_thumbnail')
    ...
    def backwards(self, orm):
        # Adding field 'Report.private_thumbnail'
        db.add_column(u'fixmystreet_report', 'private_thumbnail',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalReport.private_thumbnail'
        db.add_column(u'fixmystreet_historicalreport', 'private_thumbnail',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
