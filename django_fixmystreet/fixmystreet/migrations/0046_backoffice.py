...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganisationEntitySurface'
        db.create_table(u'fixmystreet_organisationentitysurface', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fixmystreet.OrganisationEntity'])),
            ('geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=31370)),
        ))
        db.send_create_signal(u'fixmystreet', ['OrganisationEntitySurface'])


    def backwards(self, orm):
        # Deleting model 'OrganisationEntitySurface'
        db.delete_table(u'fixmystreet_organisationentitysurface')
