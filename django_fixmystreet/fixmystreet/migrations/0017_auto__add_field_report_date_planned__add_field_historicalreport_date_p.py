...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.date_planned'
        db.add_column(u'fixmystreet_report', 'date_planned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalReport.date_planned'
        db.add_column(u'fixmystreet_historicalreport', 'date_planned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Report.date_planned'
        db.delete_column(u'fixmystreet_report', 'date_planned')

        # Deleting field 'HistoricalReport.date_planned'
        db.delete_column(u'fixmystreet_historicalreport', 'date_planned')
