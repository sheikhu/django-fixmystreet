...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.gravity'
        db.add_column(u'fixmystreet_report', 'gravity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Report.probability'
        db.add_column(u'fixmystreet_report', 'probability',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'HistoricalReport.gravity'
        db.add_column(u'fixmystreet_historicalreport', 'gravity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'HistoricalReport.probability'
        db.add_column(u'fixmystreet_historicalreport', 'probability',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Report.gravity'
        db.delete_column(u'fixmystreet_report', 'gravity')

        # Deleting field 'Report.probability'
        db.delete_column(u'fixmystreet_report', 'probability')

        # Deleting field 'HistoricalReport.gravity'
        db.delete_column(u'fixmystreet_historicalreport', 'gravity')

        # Deleting field 'HistoricalReport.probability'
        db.delete_column(u'fixmystreet_historicalreport', 'probability')
