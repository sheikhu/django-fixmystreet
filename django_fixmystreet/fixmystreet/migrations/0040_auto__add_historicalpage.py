...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoricalPage'
        db.create_table(u'fixmystreet_historicalpage', (
            ...
            ('title_fr', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug_nl', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('slug_fr', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('content_fr', self.gf('ckeditor.fields.RichTextField')()),
            ('content_nl', self.gf('ckeditor.fields.RichTextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'fixmystreet', ['HistoricalPage'])


    def backwards(self, orm):
        # Deleting model 'HistoricalPage'
        db.delete_table(u'fixmystreet_historicalpage')
