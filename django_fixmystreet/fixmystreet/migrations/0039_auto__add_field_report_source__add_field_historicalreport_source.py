...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fixmystreet_report', 'source',
                      self.gf('django.db.models.fields.TextField')(default='web'),
                      keep_default=False)

        # Adding field 'HistoricalReport.source'
        db.add_column(u'fixmystreet_historicalreport', 'source',
                      self.gf('django.db.models.fields.TextField')(default='web'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'fixmystreet_report', 'source')

        # Deleting field 'HistoricalReport.source'
        db.delete_column(u'fixmystreet_historicalreport', 'source')
