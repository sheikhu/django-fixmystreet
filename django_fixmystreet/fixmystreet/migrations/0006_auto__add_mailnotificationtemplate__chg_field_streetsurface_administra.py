...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailNotificationTemplate'
        db.create_table(u'fixmystreet_mailnotificationtemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('content_fr', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('content_nl', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('title_fr', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_nl', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'fixmystreet', ['MailNotificationTemplate'])


        # Changing field 'StreetSurface.administrator'
        db.alter_column(u'fixmystreet_streetsurface', 'administrator', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

    def backwards(self, orm):
        # Deleting model 'MailNotificationTemplate'
        db.delete_table(u'fixmystreet_mailnotificationtemplate')


        # Changing field 'StreetSurface.administrator'
        db.alter_column(u'fixmystreet_streetsurface', 'administrator', self.gf('django.db.models.fields.CharField')(default='', max_length=3))
