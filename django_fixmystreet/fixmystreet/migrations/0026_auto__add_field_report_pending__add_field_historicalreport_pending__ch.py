...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.pending'
        db.add_column(u'fixmystreet_report', 'pending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalReport.pending'
        db.add_column(u'fixmystreet_historicalreport', 'pending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Report.pending'
        db.delete_column(u'fixmystreet_report', 'pending')

        # Deleting field 'HistoricalReport.pending'
        db.delete_column(u'fixmystreet_historicalreport', 'pending')
