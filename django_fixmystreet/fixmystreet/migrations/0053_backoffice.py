...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupMailConfig'
        db.create_table(u'fixmystreet_groupmailconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notify_group', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('notify_members', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('digest_created', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('digest_inprogress', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('digest_closed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('digest_other', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fixmystreet.OrganisationEntity'], unique=True)),
        ))
        db.send_create_signal(u'fixmystreet', ['GroupMailConfig'])


    def backwards(self, orm):
        # Deleting model 'GroupMailConfig'
        db.delete_table(u'fixmystreet_groupmailconfig')
