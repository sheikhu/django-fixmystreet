...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportNotification.recipient'
        db.alter_column(u'fixmystreet_reportnotification', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fixmystreet.FMSUser']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReportNotification.recipient'
        raise RuntimeError("Cannot reverse this migration. 'ReportNotification.recipient' and its values cannot be restored.")
