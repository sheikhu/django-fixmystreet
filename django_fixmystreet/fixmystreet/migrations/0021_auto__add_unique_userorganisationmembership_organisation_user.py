...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserOrganisationMembership', fields ['organisation', 'user']
        db.create_unique(u'fixmystreet_userorganisationmembership', ['organisation_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserOrganisationMembership', fields ['organisation', 'user']
        db.delete_unique(u'fixmystreet_userorganisationmembership', ['organisation_id', 'user_id'])
