...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportAttachment.type'
        db.add_column(u'fixmystreet_reportattachment', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportAttachment.type'
        db.delete_column(u'fixmystreet_reportattachment', 'type')
