...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.terms_of_use_validated'
        db.add_column(u'fixmystreet_report', 'terms_of_use_validated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalReport.terms_of_use_validated'
        db.add_column(u'fixmystreet_historicalreport', 'terms_of_use_validated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.terms_of_use_validated'
        db.delete_column(u'fixmystreet_report', 'terms_of_use_validated')

        # Deleting field 'HistoricalReport.terms_of_use_validated'
        db.delete_column(u'fixmystreet_historicalreport', 'terms_of_use_validated')
