...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.planned'
        db.add_column(u'fixmystreet_report', 'planned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalReport.planned'
        db.add_column(u'fixmystreet_historicalreport', 'planned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.planned'
        db.delete_column(u'fixmystreet_report', 'planned')

        # Deleting field 'HistoricalReport.planned'
        db.delete_column(u'fixmystreet_historicalreport', 'planned')
