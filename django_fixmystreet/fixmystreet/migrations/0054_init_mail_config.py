...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for group in orm['fixmystreet.OrganisationEntity'].objects.filter(type=OrganisationEntity.DEPARTMENT):
            mail_config = orm['fixmystreet.GroupMailConfig']()
            mail_config.group = group
            mail_config.save()

    def backwards(self, orm):
        "Write your backwards methods here."

        orm['fixmystreet.GroupMailConfig'].objects.all().delete()
