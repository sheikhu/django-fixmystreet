...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fixmystreet_report', 'thumbnail',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalReport.thumbnail'
        db.add_column(u'fixmystreet_historicalreport', 'thumbnail',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'fixmystreet_report', 'thumbnail')

        # Deleting field 'HistoricalReport.thumbnail'
        db.delete_column(u'fixmystreet_historicalreport', 'thumbnail')
