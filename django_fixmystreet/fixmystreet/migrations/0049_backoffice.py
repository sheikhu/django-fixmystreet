...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.third_party_responsibility'
        db.add_column(u'fixmystreet_report', 'third_party_responsibility',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HistoricalReport.third_party_responsibility'
        db.add_column(u'fixmystreet_historicalreport', 'third_party_responsibility',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.third_party_responsibility'
        db.delete_column(u'fixmystreet_report', 'third_party_responsibility')

        # Deleting field 'HistoricalReport.third_party_responsibility'
        db.delete_column(u'fixmystreet_historicalreport', 'third_party_responsibility')
