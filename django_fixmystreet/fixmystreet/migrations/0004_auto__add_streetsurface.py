...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StreetSurface'
        db.create_table(u'fixmystreet_streetsurface', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('urbis_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('pw_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('ssft', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('sslv', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('version_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('administrator', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=31370)),
        ))
        db.send_create_signal(u'fixmystreet', ['StreetSurface'])


    def backwards(self, orm):
        # Deleting model 'StreetSurface'
        db.delete_table(u'fixmystreet_streetsurface')
