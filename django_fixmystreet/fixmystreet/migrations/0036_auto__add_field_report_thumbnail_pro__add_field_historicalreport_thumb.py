...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.thumbnail_pro'
        db.add_column(u'fixmystreet_report', 'thumbnail_pro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalReport.thumbnail_pro'
        db.add_column(u'fixmystreet_historicalreport', 'thumbnail_pro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.thumbnail_pro'
        db.delete_column(u'fixmystreet_report', 'thumbnail_pro')

        # Deleting field 'HistoricalReport.thumbnail_pro'
        db.delete_column(u'fixmystreet_historicalreport', 'thumbnail_pro')
