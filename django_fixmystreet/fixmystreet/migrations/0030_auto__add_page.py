...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Page'
        db.create_table(u'fixmystreet_page', (
        ...
        db.send_create_signal(u'fixmystreet', ['Page'])


    def backwards(self, orm):
        # Deleting model 'Page'
        db.delete_table(u'fixmystreet_page')
    ...
    models = {
        ...
        u'fixmystreet.historicalreport': {
            ...
            'private_thumbnail': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
