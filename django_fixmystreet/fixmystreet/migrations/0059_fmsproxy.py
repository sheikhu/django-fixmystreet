...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalOrganisationEntity.fmsproxy_id'
        db.add_column(u'fixmystreet_historicalorganisationentity', u'fmsproxy_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrganisationEntity.fmsproxy'
        db.add_column(u'fixmystreet_organisationentity', 'fmsproxy',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fmsproxy.FMSProxy'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalOrganisationEntity.fmsproxy_id'
        db.delete_column(u'fixmystreet_historicalorganisationentity', u'fmsproxy_id')

        # Deleting field 'OrganisationEntity.fmsproxy'
        db.delete_column(u'fixmystreet_organisationentity', 'fmsproxy_id')
    ...
    models = {
        ...
        u'fixmystreet.historicalorganisationentity': {
            ...
            u'fmsproxy_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'history_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'history_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'history_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'history_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
