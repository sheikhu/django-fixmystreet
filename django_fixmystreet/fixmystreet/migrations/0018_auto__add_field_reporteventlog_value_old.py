...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportEventLog.value_old'
        db.add_column(u'fixmystreet_reporteventlog', 'value_old',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportEventLog.value_old'
        db.delete_column(u'fixmystreet_reporteventlog', 'value_old')
