...
class MailTest(TestCase):
	...
	def testCreateReportMail(self):
		...
		self.client.post('/report/new?x=150056.538&y=170907.56#form',{'x':'150056.538','y':'170907.56','address':'Avenue des Arts, 3','postalcode':'1210','category':'1','secondary_category':'1','quality':'0','description':'test','citizen_email':self.citizen.email,'citizen_firstname':self.citizen.first_name,'citizen_lastname':self.citizen.last_name,'citizen_subscription':'on','secondary_category_copy':'1','photo':''})
	...
	def testCloseReportMail(self):
		...
		self.client.get('/pro/report/1/accept/')
		...
		#Close the report
		self.client.get('/pro/report/1/close/')
	...
	def testRefuseReportMail(self):
		...
		self.client.post('/pro/report/1/refuse/',{'more_info_text':'more info'})
	...
	def testSubscriptionForCititzenMail(self):
		...
		self.client.post('/report/1/subscribe/',{'citizen_email':'post@test.com'})
	...
	def testMarkReportAsDoneMail(self):
		...
		self.client.post('/report/1/update/',{'is_fixed':'1'})
